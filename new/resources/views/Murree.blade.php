...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/css/pkg.css')}}">
...
<body>
    ...
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="d-flex align-items-center justify-content-center" style="background-image: url(assets/img/packageDeet/murree.jpeg);">
        <div class="container" data-aos="fade-up">

            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-6 col-lg-8">
                    <h1>Murree 3 Days – 2 Nights Tour Package</h1>
        ...
        <div id="page_content_wrapper" class="hasbg withtopbar ">
                ...
                <div class="inner_wrapper">
                    ...
                    <div class="sidebar_content ">
                        ...
                        <div class="single_tour_content">
                            ...
                            <h4>Day-0</h4>
                            <p style="margin-left: 100px;">Arrival to Islamabad </p>
                            <h4>Day-1</h4>
                            <ul style="margin-left: 70px;">Islamabad to Murree and then NathiaGali</ul>
                            <ul style="margin-left: 70px;">Stay at Murree</ul>
                            <h4>Day-2</h4>
                            <ul style="margin-left: 70px;">Murree to Abottabad</ul>
                            <ul style="margin-left: 70px;">Stay at Murree</ul>
                            <h4>Day-3</h4>
                            <p style="margin-left: 100px;">Murree to Islamabad</p>
            ...
            <div class="container" data-aos="zoom-in">
                <div class="text-center">
                    ...
                    <button style="background-color:lightgreen; width: 200px; border-radius:20px; padding: 10px;"> <a href="{{route('bookings', ['place'=>'Murree',,'price'=>10000,'d_date'=>'2022-12-26','r_date'=>'2022-12-27','is_customized'=>false])}}">Book Now</a></button>
                </div>
